---
name: Bug Report
about: Report a bug found in M3 Play to help us improve the application
...
```
**How to capture logs:**
- Use `adb logcat | grep -i m3play` for filtered logs
...
- [ ] I have tested on the latest version of M3 Play
