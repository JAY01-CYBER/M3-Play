...
object UpdateNotificationHelper {
    ...
    fun showUpdateNotification(context: Context, versionName: String) {
        ...
        // Direct download URL format from M3-Playupdater - use the full tag (vX.X.X or bX.X.X)
        val apkUrl = "https://github.com/m3playzzz007/m3-play/releases/download/$versionName/m3-play.apk"
