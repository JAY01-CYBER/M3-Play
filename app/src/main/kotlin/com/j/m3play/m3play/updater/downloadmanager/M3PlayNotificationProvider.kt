package com.j.m3play.M3-Play.updater.downloadmanager
...
class M3PlayNotificationProvider(
     ...
     */
    fun setSmallIcon(iconResId: Int): M3PlayNotificationProvider {
    ...
    override fun createNotification(
        ...
        if (isAndroid16) {
            ...
            builder.setSmallIcon(R.drawable.m3play)
