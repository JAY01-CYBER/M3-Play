...
import com.j.m3play.constants.ListenTogetherAutoApprovalKey
import com.j.m3play.constants.ListenTogetherIsHostKey
import com.j.m3play.constants.ListenTogetherRoomCodeKey
import com.j.m3play.constants.ListenTogetherServerUrlKey
import com.j.m3play.constants.ListenTogetherSessionTimestampKey
import com.j.m3play.constants.ListenTogetherSessionTokenKey
import com.j.m3play.constants.ListenTogetherUserIdKey
...
class ListenTogetherClient @Inject constructor(
    ...
    companion object {
        ...
        const val ACTION_APPROVE_JOIN = "com.j.m3play.LISTEN_TOGETHER_APPROVE_JOIN"
        const val ACTION_REJECT_JOIN = "com.j.m3play.LISTEN_TOGETHER_REJECT_JOIN"
        const val ACTION_APPROVE_SUGGESTION = "com.j.m3play.LISTEN_TOGETHER_APPROVE_SUGGESTION"
        const val ACTION_REJECT_SUGGESTION = "com.j.m3play.LISTEN_TOGETHER_REJECT_SUGGESTION"
    ...
    private fun loadBlockedUsernames() {
        try {
            val blockedJson = context.dataStore.get(com.j.m3play.constants.ListenTogetherBlockedUsersKey, "")
    ...
    private suspend fun saveBlockedUsernames() {
        try {
            ...
            context.dataStore.edit { preferences ->
                preferences[com.j.m3play.constants.ListenTogetherBlockedUsersKey] = blockedJson
            }
        } catch (e: Exception) {
