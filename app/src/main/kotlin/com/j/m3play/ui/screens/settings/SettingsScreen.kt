...
fun SettingsScreen(
    ...
    val isUpdateAvailable = getUpdateAvailableState(context) && com.j.m3play.M3-Play.updater.getAutoUpdateCheckSetting(context)
            ...
            items = buildList {
                add(
                    Material3SettingsItem(
                        icon = painterResource(if (isUpdateAvailable) R.drawable.M3-Playnotification else R.drawable.network_update),
