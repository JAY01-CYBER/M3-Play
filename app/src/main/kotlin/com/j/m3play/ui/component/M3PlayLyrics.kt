...
/**
 * Exact Apple Music style lyrics animation ported from m3-play-5.0.3
 * Features:
...
fun M3PlayLyricsLine(
    ...
    val wordData = remember(entry.text, entry.words, activeDuration) {
        val isHindiText = com.j.m3play.lyrics.LyricsUtils.isHindi(entry.text)
