# Working with M3-Play as an AI agent

M3-Play is a 3rd party YouTube Music client written in Kotlin. It follows material 3 design guidelines closely.
...
6. All string edits should be made to the `M3-Play/app/src/main/res/values/M3-Play_strings.xml` file, NOT `M3-Play/app/src/main/res/values/strings.xml`. Do not touch other `strings.xml` or `M3-Play_strings.xml` files in the project.
