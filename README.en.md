...
<div align="center">
  <img src="https://github.com/Arturo254/M3 Play/blob/master/fastlane/metadata/android/en-US/images/featureGraphic.png" alt="M3 Play Banner" width="100%"/>
  
  ### Advanced YouTube Music Client with Material Design 3 for Android
  
  [![Latest Release](https://img.shields.io/github/v/release/Arturo254/M3 Play?style=flat-square&logo=github&color=0D1117&labelColor=161B22)](https://github.com/Arturo254/M3 Play/releases)
  [![License](https://img.shields.io/github/license/Arturo254/M3 Play?style=flat-square&logo=gnu&color=2B3137&labelColor=161B22)](https://github.com/Arturo254/M3 Play/blob/main/LICENSE)
  [![Translation Status](https://badges.crowdin.net/m3play/localized.svg)](https://crowdin.com/project/m3play)
  ...
  [![Stars](https://img.shields.io/github/stars/Arturo254/M3 Play?style=flat-square&logo=github&color=yellow&labelColor=161B22)](https://github.com/Arturo254/M3 Play/stargazers)
...
> **Note**: M3 Play is an independent project and is not affiliated, sponsored, or endorsed by YouTube or Google.
...
[![Documentation](https://img.shields.io/badge/Documentation-GitBook-4285F4?style=for-the-badge&logo=gitbook&logoColor=white)](https://m3play.gitbook.io/)
...
1. Navigate to the [Releases](https://github.com/Arturo254/M3 Play/releases) section on GitHub
...
1. Visit the official [M3 Play website](https://m3play.netlify.app/)
...
3. Navigate and select the M3 Play directory
...
All participants in this project must adhere to our code of conduct that promotes an inclusive, respectful, and constructive environment. Please review the [complete Code of Conduct](https://github.com/Arturo254/M3 Play/blob/master/CODE_OF_CONDUCT.md) before contributing.

### Translation

Help translate M3 Play into your language or improve existing translations:
...
[![Telegram Chat](https://img.shields.io/badge/Telegram-Chat-2CA5E0?style=for-the-badge&logo=telegram&logoColor=white)](https://t.me/M3 Play_chat)
[![Telegram Updates](https://img.shields.io/badge/Telegram-Updates-2CA5E0?style=for-the-badge&logo=telegram&logoColor=white)](https://t.me/m3play_updates)

</div>

### Development Workflow

1. **Issue Review**: Check [open issues](https://github.com/Arturo254/M3 Play/issues) or create a new one describing the problem or feature
...
> **Development Guidelines**: Review our [contribution guidelines](https://github.com/Arturo254/M3 Play/blob/master/CONTRIBUTING.md) for detailed information about development process, code standards, and workflow.

---

## Support the Project

If you find value in **M3 Play** and want to contribute to its continued development, consider making a donation. Your financial support allows us to:
...
> **Note**: Donations are completely optional. M3 Play will always be free and open-source, regardless of financial support received.
...
- **Community translators** - Making M3 Play accessible worldwide
...
This program is distributed in the hope that it will be useful, but **WITHOUT ANY WARRANTY**; without even the implied warranty of MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE. See the [GNU General Public License](https://github.com/Arturo254/M3 Play/blob/main/LICENSE) for more details.
